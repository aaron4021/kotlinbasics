...
class DogCardAdapter(
    ...
    override fun onBindViewHolder(holder: DogCardViewHolder, position: Int) {
        ...
        val dogCurrent = dogList[position]
        holder.imageView.setImageResource(dogCurrent.imageResourceId)
        holder.textView1.text = dogCurrent.name
        holder.textView2.text = resources?.getString(R.string.dog_age, dogCurrent.age)
        holder.textView3.text = resources?.getString(R.string.dog_hobbies, dogCurrent.hobbies)
